...
heroAlt: 'Bar chart comparing India’s solar module manufacturing capacity (172 GW) with its solar cell capacity (27 GW) in 2026.'
sources:
  - label: 'Akashvani News: module capacity rises to 172 GW — Union Minister Pralhad Joshi'
    url: 'https://newsonair.gov.in/indias-solar-module-manufacturing-capacity-rises-from-3-gw-to-17-2-gw-union-minister-pralhad-joshi/'
  - label: 'IEEFA: India’s rising prominence in solar photovoltaic manufacturing'
    url: 'https://ieefa.org/resources/indias-rising-prominence-solar-photovoltaic-manufacturing'
  - label: 'India Briefing: an investor’s guide to solar manufacturing in India'
    url: 'https://www.india-briefing.com/news/an-investors-guide-to-solar-manufacturing-in-india-39923.html/'
---
...
- **PLI incentives** reward integrated manufacturing across polysilicon-to-module;
- **ALMM List-II**, in force since June 2026, extends domestic-content rules to cells;
- **Import duties** keep a floor under domestic pricing.
