...
heroAlt: 'Stat graphic: MNRE allocation of ₹32,914 crore, up 30% year on year, with priorities of solar, storage and the Green Hydrogen Mission.'
sources:
  - label: 'ESG News: MNRE allocation and storage growth context'
    url: 'https://www.esgnews.earth/latest-news/india-battery-storage-must-grow-888-fold/20604.html'
...
- **Solar schemes** — with PM Surya Ghar's rooftop subsidies the single biggest consumer of funds as installation volumes double;
- **Grid-scale storage** — viability gap funding for battery energy storage systems, the instrument behind much of the current BESS construction boom;
- **Green energy corridors** — the transmission build-out that renewable-rich states need to evacuate power;
- **The National Green Hydrogen Mission** — continued funding for electrolyser and production incentives plus the new industrial pilot rounds.
