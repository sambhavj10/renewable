...
heroAlt: 'Bar chart comparing rooftop solar additions: about 3.1 GW in H1 2025 versus 6.4 GW in H1 2026.'
sources:
  - label: 'Down To Earth: rooftop boom drives record H1 2026 additions'
    url: 'https://www.downtoearth.org.in/energy/india-adds-record-29-gw-solar-wind-in-first-half-of-2026'
  - label: 'Renewables Now: India adds 26 GW of solar in H1 2026'
    url: 'https://renewablesnow.com/news/india-adds-26-gw-of-solar-2-9-gw-of-wind-power-in-h1-2026-1297889/'
  - label: 'PM Surya Ghar: Muft Bijli Yojana (official portal)'
...
- **Cut the payback period** for a typical residential system to just a few years in most states;
- **Standardised the process** — vendor registration, net metering and subsidy disbursal now run through a single national portal;
- **Built installer capacity**, with a wave of new rooftop businesses registered across tier-2 and tier-3 cities.
